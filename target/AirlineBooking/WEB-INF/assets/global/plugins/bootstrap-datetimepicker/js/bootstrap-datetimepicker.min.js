!function (e) {
    ...
    "indexOf" in Array.prototype || (Array.prototype.indexOf = function (e, i) {
        ...
        for (var s = this.length; s > i; i++) if (i in this && this[i] === e) return i;
        return -1
    });
    var a = function (s, a) {
        var n = this;
        ...
        e(document).on("mousedown touchend", this.clickedOutside), this.autoclose = !1, "autoclose" in a ? this.autoclose = a.autoclose : "dateAutoclose" in this.element.data() && (this.autoclose = this.element.data("date-autoclose")), this.keyboardNavigation = !0, "keyboardNavigation" in a ? this.keyboardNavigation = a.keyboardNavigation : "dateKeyboardNavigation" in this.element.data() && (this.keyboardNavigation = this.element.data("date-keyboard-navigation")), this.todayBtn = a.todayBtn || this.element.data("date-today-btn") || !1, this.clearBtn = a.clearBtn || this.element.data("date-clear-btn") || !1, this.todayHighlight = a.todayHighlight || this.element.data("date-today-highlight") || !1, this.weekStart = 0, "undefined" != typeof a.weekStart ? this.weekStart = a.weekStart : "undefined" != typeof this.element.data("date-weekstart") ? this.weekStart = this.element.data("date-weekstart") : "undefined" != typeof h[this.language].weekStart && (this.weekStart = h[this.language].weekStart), this.weekStart = this.weekStart % 7, this.weekEnd = (this.weekStart + 6) % 7, this.onRenderDay = function (e) {
            ...
            var s = e.getUTCFullYear(), n = this.endDate.getUTCFullYear();
    ...
    a.prototype = {
        constructor: a, _events: [], _attachEvents: function () {
            ...
            if (this.date && this.viewDate) {
                var t = new Date(this.viewDate), i = t.getUTCFullYear(), a = t.getUTCMonth(), o = t.getUTCDate(),
                    d = t.getUTCHours(), l = this.startDate.getUTCFullYear(), u = this.startDate.getUTCMonth(),
                    c = this.endDate.getUTCFullYear(), p = this.endDate.getUTCMonth() + 1,
                ...
                var v = s(i, a - 1, 28, 0, 0, 0, 0), w = r.getDaysInMonth(v.getUTCFullYear(), v.getUTCMonth());
                ...
                var C = "", k = "", M = "", b = this.hoursDisabled || [];
            ...
            switch (this.viewMode) {
                case 0:
                    t <= this.startDate.getUTCFullYear() && i <= this.startDate.getUTCMonth() && s <= this.startDate.getUTCDate() && a <= this.startDate.getUTCHours() ? this.picker.find(".prev").css({visibility: "hidden"}) : this.picker.find(".prev").css({visibility: "visible"}), t >= this.endDate.getUTCFullYear() && i >= this.endDate.getUTCMonth() && s >= this.endDate.getUTCDate() && a >= this.endDate.getUTCHours() ? this.picker.find(".next").css({visibility: "hidden"}) : this.picker.find(".next").css({visibility: "visible"});
                    break;
                case 1:
                    t <= this.startDate.getUTCFullYear() && i <= this.startDate.getUTCMonth() && s <= this.startDate.getUTCDate() ? this.picker.find(".prev").css({visibility: "hidden"}) : this.picker.find(".prev").css({visibility: "visible"}), t >= this.endDate.getUTCFullYear() && i >= this.endDate.getUTCMonth() && s >= this.endDate.getUTCDate() ? this.picker.find(".next").css({visibility: "hidden"}) : this.picker.find(".next").css({visibility: "visible"});
                    break;
                case 2:
            ...
            if (i.is("." + this.icontype) && (i = e(i).parent().closest("span, td, th, legend")), 1 === i.length) {
                ...
                switch (i[0].nodeName.toLowerCase()) {
                    ...
                    case"span":
                        if (!i.is(".disabled")) {
                            var h = this.viewDate.getUTCFullYear(), o = this.viewDate.getUTCMonth(),
                                d = this.viewDate.getUTCDate(), l = this.viewDate.getUTCHours(),
                                u = this.viewDate.getUTCMinutes(), c = this.viewDate.getUTCSeconds();
                    ...
                    case"td":
                        if (i.is(".day") && !i.is(".disabled")) {
                            var d = parseInt(i.text(), 10) || 1, h = this.viewDate.getUTCFullYear(),
                                o = this.viewDate.getUTCMonth(), l = this.viewDate.getUTCHours(),
                                u = this.viewDate.getUTCMinutes(), c = this.viewDate.getUTCSeconds();
            ...
            if (!t) return e;
            var i, s, a = new Date(e.valueOf()), n = a.getUTCDate(), h = a.getUTCMonth(), r = Math.abs(t);
    ...
    e.fn.datetimepicker = function (i) {
        ...
        return this.each(function () {
            var h = e(this), r = h.data("datetimepicker"), o = "object" == typeof i && i;
    ...
    var h = e.fn.datetimepicker.dates = {
        ...
        parseDate: function (t, i, n, r, o) {
            ...
            if (/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(t) && (i = this.parseFormat("yyyy-mm-dd", r)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(t) && (i = this.parseFormat("yyyy-mm-dd hh:ii", r)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(t) && (i = this.parseFormat("yyyy-mm-dd hh:ii:ss", r)), /^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(t)) {
                var l, u, c = /([-+]\d+)([dmwy])/, p = t.match(/([-+]\d+)([dmwy])/g);
                t = new Date;
            ...
            var f, g, l, p = t && t.toString().match(this.nonpunctuation) || [], t = new Date(0, 0, 0, 0, 0, 0, 0),
                v = {},
                    ...
                    if (f = parseInt(p[m], 10), l = i.parts[m], isNaN(f)) switch (l) {
                        case"MM":
                            g = e(h[n].months).filter(function () {
                                var e = this.slice(0, p[m].length), t = p[m].slice(0, e.length);
                                return e === t
        ...
        formatDate: function (t, i, s, a, n) {
            ...
            if ("standard" === a) o = {
                ...
                s: t.getUTCSeconds(),
                z: n
            }, 2 === h[s].meridiem.length ? o.H = o.h % 12 === 0 ? 12 : o.h % 12 : o.H = o.h, o.HH = (o.H < 10 ? "0" : "") + o.H, o.P = o.p.toUpperCase(), o.Z = o.z, o.hh = (o.h < 10 ? "0" : "") + o.h, o.ii = (o.i < 10 ? "0" : "") + o.i, o.ss = (o.s < 10 ? "0" : "") + o.s, o.dd = (o.d < 10 ? "0" : "") + o.d, o.mm = (o.m < 10 ? "0" : "") + o.m; else {
