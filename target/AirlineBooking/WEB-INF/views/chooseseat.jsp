    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="home">
            <div class="abs_container clearfix b_container">
                <form action="finduseridbyID.action" method="post" class="b_form">
                    <span class="b_form_title">用户：${sessionScope.get('userSession').userName}</span>
                    <input type="hidden" name="idnumber" value="${useriden}">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="用户ID" style="border:0px;background-color:transparent;">${sessionScope.get('userSession').userId}
                </form>
